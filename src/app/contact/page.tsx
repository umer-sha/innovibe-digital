...
export default function InnovibeContactUs() {
        ...
        <section className="pt-32 pb-16 px-6 lg:px-12 text-center relative overflow-hidden">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <h1 className={`text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] ${isLightMode ? 'text-slate-900' : 'text-white'}`}>
              Let's Build Your<br />
              <span className="bg-gradient-to-r from-[#7d5aff] to-cyan-400 bg-clip-text text-transparent">AI Sales Engine</span>
            </h1>

            <p 
              className="text-base sm:text-lg max-w-xl mx-auto font-normal leading-relaxed pt-2"
              style={{ color: isLightMode ? 'rgb(71, 85, 105)' : 'rgb(148, 163, 184)' }}
            >
              Have questions about our AI agents? Want to see a custom demo? Reach out to our team and we'll get back to you instantly.
            </p>

          </div>
        </section>

        {/* CONTACT SECTION (GRID: Email Direct & Form) */}
        <section className="py-12 px-6 lg:px-12 max-w-7xl mx-auto mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            
            {/* Left Box: Email Us Directly */}
            <div 
              className={`lg:col-span-4 rounded-3xl border p-8 space-y-4 transition-colors duration-300 ${
            ...
            >
              ...
              <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-slate-400'}`}>
                Speak to our friendly team about your needs.
              </p>
              <a 
                href="mailto:info@innovibedigital.com" 
                className="inline-block text-sm font-bold text-[#7d5aff] hover:underline pt-2"
              >
                info@innovibedigital.com
              </a>
            </div>

            {/* Right Box: Send Us a Message Form */}
            <div 
              className={`lg:col-span-8 rounded-3xl border p-8 sm:p-10 transition-colors duration-300 ${
                isLightMode ? 'bg-white border-slate-200 shadow-xl' : 'bg-[rgb(9,10,24)] border-white/10'
              }`}
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className={`block text-xs font-semibold uppercase tracking-wider ${isLightMode ? 'text-slate-700' : 'text-slate-300'}`}>
                      Full Name
                    </label>
                    <input 
                      type="text" 
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className={`w-full border rounded-xl p-4 text-sm focus:outline-none focus:border-purple-500 transition resize-none ${
                      isLightMode ? 'bg-slate-50 border-slate-300 text-slate-900 placeholder-slate-400' : 'bg-black/40 border-white/10 text-white placeholder-slate-500'
                    }`}
                  ></textarea>
                </div>
                ...
                <button
                  type="submit"
                  className="bg-[#7d5aff] hover:bg-[#6c47ff] text-white font-semibold text-sm px-8 py-3.5 rounded-xl transition duration-200 shadow-lg cursor-pointer flex items-center justify-center gap-2"
                >
                  Send Message
                </button>
              </form>
