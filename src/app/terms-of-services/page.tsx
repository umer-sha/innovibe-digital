...
export default function InnovibeTermsOfService() {
        ...
        <section className="pt-36 pb-20 px-6 lg:px-12 max-w-5xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-3">
            <div className="flex items-center justify-center gap-2 text-xs font-medium text-slate-400">
              ...
              <span>›</span>
              <span className={isLightMode ? 'text-slate-700' : 'text-slate-200'}>Terms of Service</span>
            </div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-slate-300'}`}>
                By accessing and using our services, you accept and agree to be bound by the terms and provision of this agreement. Innovibe Digital provides AI-powered voice agents and automation tools for businesses.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-slate-300'}`}>
                Innovibe Digital provides AI-powered voice and automation solutions tailored for local businesses.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-slate-300'}`}>
                You are responsible for maintaining the confidentiality of your account and password and for restricting access to your computer. You agree to:
              </p>

              <ul className="space-y-3 text-sm text-slate-300">
                <li className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-purple-600 mt-2 shrink-0"></span>
                  <span className={isLightMode ? 'text-slate-600' : 'text-slate-300'}>Provide accurate and complete information during registration.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-purple-600 mt-2 shrink-0"></span>
                  <span className={isLightMode ? 'text-slate-600' : 'text-slate-300'}>Notify us immediately of any unauthorized use of your account.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-slate-300'}`}>
                All content included on this site, such as text, graphics, logos, button icons, images, audio clips, digital downloads, data compilations, and software, is the property of Innovibe Digital or its content suppliers and protected by international copyright laws.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-slate-300'}`}>
                Innovibe Digital shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or the inability to use the service.
              </p>
            </div>
